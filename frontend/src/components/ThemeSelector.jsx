  ...
  return (
    <div className='max-w-7xl mx-auto px-4'>
        ...
        sm:p-6 bg-gradient-to-r from-white to-violet-50 rounded-2xl border border-violet-100'>
            ...
            from-violet-600 to-fuchsia-600 text-white font-black hover:scale-105 rounded-2xl transition-all 
            shadow-lg hover:shadow-xl' onClick={handleThemeSelection}>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8'>
            <div className='lg:col-span-2 bg-white rounded-2xl border border-gray-100 p-4 sm:p-6'>
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 mmax-h-[60vh] lg:max-h-[70vh] overflow-auto p-2'>
                    {resumeTemplates.map((template, index) => (
                        <TemplateCard key={`templates_${index}`} thumbnailImg={template.thumbnailImg}
