...
const EditResume = () => {
  ...
  //TAKE BACK TO PREVIOUS FORM STATE OR TAKE BACK TO /DASHBOARD IF YOU ARE ON THE FIRST PAGE
  const goBack = () => {
    const pages = [
      "profile-info",
      "contact-info",
  ...
  //FECTHING THE RESUME DETIALS USING BACKEND URL
  ...
  //IT WILL IN CHOOSING THE PREVIEW AS WELL AS HELPS IN DOWNLOADING THE RESUME, ALSO SAVES THE RESUME AS IMAGES
  ...
  const downloadPDF = async () => {
    ...
    try {
      await html2pdf()
        ...
        .from(element)
        .save();  //WE SAVE THE RESUME HERE AND DOWNLOAD IT
  ...
  return (
    <DashboardLayout>
        <div className={containerStyles.main}>
            <div className={containerStyles.header}>
                ...
                <div className='flex flex-wrap items-center gap-3'>
                  ...
                  <button className={buttonStyles.download} onClick={() => setOpenPreviewModal(true)}>
                    <Download size={16}/>
                ...
                <div className='p-4 sm:p-6'>
                  ...
                  <div className='flex flex-wrap items-center justify-end gap-3'>
                    ...
                    <button className={buttonStyles.next} onClick={validateAndNext} disabled={isLoading}>
                      {currentPage === "additonalInfo" && <Download size={16}/>}
                      {currentPage === "additonalInfo" ? "Preview & Download" : "Next"}
                      {currentPage === "additonalInfo" && <ArrowLeft size={16} className='rotate-180'/>}
                    </button>
                  </div>
                </div>
              </div>
        ...
        <Modal isOpen={openPreviewModal} onClose={() => setOpenPreviewModal(false)}
          title={resumeData.title} showActionBtn actionBtnText={isDownloading? "Generating..."
