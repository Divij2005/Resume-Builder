...
import { commonStyles, dashboardStyles as styles } from '../assets/dummyStyle'
import { useNavigate } from 'react-router-dom'
import { LucideFilePlus, LucideTrash2, Trash2Icon } from 'lucide-react'
...
const Dashboard = () => {
  ...
  const fetchAllResumes = async() => {
    try {
      ...
      //ADD COMPLETION PERECNT TO EACH RESUME 
        ...
        {!loading && allResumes.length > 0 && (
          <div className={styles.grid}>
            ...
            {allResumes.map((resume) => (
              <ResumeSummaryCard key={resume._id} image={resume.thumbnailLink} title={resume.title} createdAt={resume.createdAt}
